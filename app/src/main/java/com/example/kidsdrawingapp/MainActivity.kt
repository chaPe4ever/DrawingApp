...
class MainActivity : AppCompatActivity() {
    ...
    private var customProgresDialog: Dialog? = null
    private var mSavedBitmapPath : String? =null
        ...
        registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions()) { permissions ->
            permissions.entries.forEach {
                ...
                if (isGranted) {
                    ...
                    Toast.makeText(
                        this,
                        "Permission: $permissionName has been denied",
                        Toast.LENGTH_LONG
                    ).show()
                }
            }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ibGallery.setOnClickListener {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && shouldShowRequestPermissionRationale(
                ...
                showRationaleDialog(
                    "Permission required storage access",
        ...
        ibSave.setOnClickListener {
            if (isReadStorageAllowed()) {
                ...
                lifecycleScope.launch {
                    ...
                    mSavedBitmapPath = saveBitmapFile(getBitmapFromView(flDrawingView))
                }
            }
        }

        ibShare.setOnClickListener {
            if(mSavedBitmapPath.isNullOrEmpty()){
                Toast.makeText(this, "You should save first the image in order to proceed", Toast.LENGTH_LONG).show()
            }else{
                shareImage(mSavedBitmapPath!!)
                mSavedBitmapPath = null
            }
        }
    }
    ...
    private fun showProgressDialog(){
        ...
        customProgresDialog?.setContentView(R.layout.dialog_custom_progress)
